                ...
                <div className="flex flex-col justify-between w-full pb-4">
                    <div className="flex justify-between w-full pb-2 space-x-2">
                        <div className="space-y-1 ">
                            ...
                            <p className="text-sm dark:text-gray-400">Status : {service_status} </p>
                        </div>
                    ...
                    <div className="flex text-sm divide-x">
                        ...
                        <button type="button" className="flex items-center px-2 py-1 space-x-1">
                            <div className="text-right">
                                ...
                                <select id="underline_select" className="block py-2.5 px-0 lg:md:sm:px-1 w-full text-sm lg:md:sm:text-lg text-green-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
